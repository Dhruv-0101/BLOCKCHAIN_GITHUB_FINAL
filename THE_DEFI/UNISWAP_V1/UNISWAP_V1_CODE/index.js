...
const rpcUrl = `https://mainnet.infura.io/v3/2de477c3b1b74816ae5475da6d289208`;
...
async function getFactoryContract() {
    ...
    const exchangeAddress = await factoryContract.getExchange(DAIStableCoin);
    const tokenAddress = await factoryContract.getToken(exchangeAddress);
    console.log("tokenAddress:", tokenAddress);
    const tokenCount = await factoryContract.tokenCount();
    console.log("Number of tokens with exchanges:", tokenCount.toString());
    const exchangeContract = new ethers.Contract(exchangeAddress, exchangeABI, provider);
    const price = await exchangeContract.getEthToTokenInputPrice(ethers.parseEther("1"));
    console.log("Tokens for 1 ETH:", ethers.formatUnits(price, 18));
    console.log("exchangeAddress:", exchangeAddress);
    console.log("factoryContract:", factoryContract);
}

getFactoryContract().catch(console.error);